...
/**
 * @file shard.h
 * @brief Defines the Shard class, which manages a shard committee and its operations.
 *
...
public:
     ...
     * @param leaderRank The rank of the leader node within the shard communicator.
     */
...
private:
    ...
    // Internal state for the PBFT process would be managed here or in a dedicated PBFT class.
};
