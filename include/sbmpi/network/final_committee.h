 ...
 *
 * The FinalCommittee is responsible for collecting validated MicroBlocks from all
 * shards, verifying them, and assembling them into a MacroBlock. This MacroBlock
* represents the final, authoritative state of the blockchain for a given epoch.
 */
