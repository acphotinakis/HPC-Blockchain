...
public:
    /**
     * @brief Default constructor. Initializes the blockchain, possibly with a genesis block.
     */
    Blockchain();
     ...
     *
     * @return A const pointer to the latest block, or nullptr if the chain is empty.
     */
