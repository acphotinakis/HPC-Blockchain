...
/**
 * @file node.h
 * @brief Defines the Node class, representing a participant in the blockchain
 * network.
 *
 * Each MPI process in the simulation corresponds to a Node. This class holds
 * information about the node's identity, its role within the network (e.g.,
 * part of a specific shard or the final committee), and its MPI ranks.
 */
