...
/**
 * @file macro_block.h
 * @brief Defines the MacroBlock class, a block that aggregates multiple MicroBlocks.
 *
 * A MacroBlock is created by the final committee. It does not contain transactions
 * directly, but rather a list of hashes of the MicroBlocks that were validated
* and accepted from the shards during a given epoch. This forms the final,
 * authoritative chain.
 */
