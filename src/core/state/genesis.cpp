...
namespace sbmpi
{
  namespace core
  {
    namespace state
    {
       ...
       *
       * The genesis block is the first block in the blockchain, initialized
       * with a height of 0, a "0" previous hash, a "0" Merkle root (as there
       * are no initial transactions to hash), and the current timestamp.
       * @return A unique_ptr to the newly created MacroBlock representing the
       * genesis block.
       */
